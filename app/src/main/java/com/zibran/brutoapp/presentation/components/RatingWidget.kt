...
import com.zibran.brutoapp.ui.theme.EXTRA_SMALL_PADDING
import com.zibran.brutoapp.ui.theme.LightGrey
import com.zibran.brutoapp.ui.theme.StarColor
...
fun EmptyStar(
    ...
    Canvas(modifier = Modifier.size(24.dp)) {
        ...
        scale(scale = scaleFactor) {
            ...
            val left = (canvasSize.width / 2) - (pathWith / 2)
...
fun calculateStar(rating: Double): Map<String, Int> {
    ...
    var halfFiledStars by remember { mutableIntStateOf(0) }
    ...
    emptyStars = maxStars - (filledStars + halfFiledStars)
    return mapOf(
        "filledStars" to filledStars,
        "halfFilledStars" to halfFiledStars,
...
fun EmptyStarPreview() {
    ...
    EmptyStar(starPath = starPath, starPathBounds = starPathBounds, 3f)
}
...
fun HalfFilledStarPreview() {
    ...
    HalfFilledStar(starPath = starPath, starPathBounds = starPathBounds, 3f)
}
...
fun FilledStarPreview() {
    ...
    FilledStar(starPath = starPath, starPathBounds = starPathBounds, 3f)
